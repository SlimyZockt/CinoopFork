...
void cb_n(unsigned char instruction) {
  ...
  // printf("%s\n", extendedInstructions[instruction].disassembly);
}
...
// 0x86
void res_0_hlp(void) {
  writeByte(registers.hl, readByte(registers.hl) & ~(1 << 0));
}
...
// 0xbe
void res_7_hlp(void) {
  writeByte(registers.hl, readByte(registers.hl) & ~(1 << 7));
}
...
// 0xc6
void set_0_hlp(void) {
  writeByte(registers.hl, set(1 << 0, readByte(registers.hl)));
}
...
// 0xce
void set_1_hlp(void) {
  writeByte(registers.hl, set(1 << 1, readByte(registers.hl)));
}
...
// 0xd6
void set_2_hlp(void) {
  writeByte(registers.hl, set(1 << 2, readByte(registers.hl)));
}
...
// 0xde
void set_3_hlp(void) {
  writeByte(registers.hl, set(1 << 3, readByte(registers.hl)));
}
...
// 0xe6
void set_4_hlp(void) {
  writeByte(registers.hl, set(1 << 4, readByte(registers.hl)));
}
...
// 0xee
void set_5_hlp(void) {
  writeByte(registers.hl, set(1 << 5, readByte(registers.hl)));
}
...
// 0xf6
void set_6_hlp(void) {
  writeByte(registers.hl, set(1 << 6, readByte(registers.hl)));
}
...
// 0xfe
void set_7_hlp(void) {
  writeByte(registers.hl, set(1 << 7, readByte(registers.hl)));
}
